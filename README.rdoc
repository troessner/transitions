...
{<img src="https://badge.fury.io/rb/transitions.png" alt="Gem Version" />}[http://badge.fury.io/rb/transitions]
...
<tt>transitions</tt> does not work with ruby 1.8.7 (see {this issue}[https://github.com/troessner/transitions/issues/86] for example).
